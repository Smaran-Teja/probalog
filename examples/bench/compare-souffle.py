...
# Sizes are chosen so the largest takes probalog a few seconds. Racket
# startup is ~0.47s and is inside every probalog measurement, so on a
# half-second program it would be most of the number; at a few seconds
# it is noise. The smaller sizes are kept to show the growth.
SUITES = {
    "ring": dict(blurb="directed cycle", fam=fam_ring,
                 sizes=[(20,), (60,), (100,), (120,)], quick=[(20,), (60,)]),
    "chordring": dict(blurb="cycle + chords: dense and cyclic", fam=fam_chordring,
                      sizes=[(12,), (16,), (20,), (22,)], quick=[(12,), (16,)]),
    "dag": dict(blurb="layered DAG: many converging derivations", fam=fam_dag,
                sizes=[(4, 3), (6, 4), (7, 5), (6, 6)], quick=[(4, 3), (6, 4)]),
    "sg": dict(blurb="same generation over a balanced tree", fam=fam_sg,
               sizes=[(4,), (5,), (6,), (7,)], quick=[(4,), (5,)]),
    "pointsto": dict(blurb="Andersen's points-to analysis", fam=fam_pointsto,
                     sizes=[(16,), (60,), (100,), (150,)], quick=[(16,), (60,)]),
}
